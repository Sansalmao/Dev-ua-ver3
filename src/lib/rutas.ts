...
export const RUTAS: Record<string, RutaData> = {
  educator_basica: {
    ...
    temas: [
      {
        id: "eb-01",
        titulo: "Introducción a la Aceptación Universal",
        nivel: "Básico",
        duracion: "1h 30min",
        descripcion:
      ...
      {
        id: "eb-02",
        titulo: "Internacionalización de Dominios (IDN)",
        nivel: "Básico",
        duracion: "2h 00min",
        descripcion:
      ...
      {
        id: "eb-03",
        titulo: "Email Internacional (EAI)",
        nivel: "Básico",
        duracion: "1h 45min",
        descripcion:
      ...
      {
        id: "eb-04",
        titulo: "Diseño de Laboratorios de UA",
        nivel: "Básico",
        duracion: "2h 15min",
        descripcion:
      ...
      {
        id: "eb-05",
        titulo: "Normativas RFC y Estándares IETF",
        nivel: "Básico",
        duracion: "1h 30min",
        descripcion:
